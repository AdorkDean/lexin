...
<%
    ...
    if (null != obj) {
        ...
        if (null != find) {
            user = find.getUser_name();
            money = find.getUser_money();
        }
    }
%>
<noscript>
...
<nav id="topNav">
    <div id="topNavWrap">
        <div id="topNavLeft">
            <script>local.NavInit("<%=user%>", "<%=money%>")</script>
        </div>
        <ul id="topNavRight">
            ...
            <li>
                <div class="mcDropMenuBox">
                    <a target="_top" class="topNavHolder" href="/my/Index.jzh" rel="nofollow">我的彩票<i></i></a><b
                        class="holderLine">|</b>
...
<header id="docHead" style="background-image:url('/ad/img/ad_head.png');">
    <div id="docHeadWrap">
        <a href="/Index.jzh" class="logoLnk" title="乐欣彩票" hidefocus="true"><h1 rel="nofollow">乐欣彩票<img
                src="/img/logos/caipiao.png" alt="乐欣彩票" title="乐欣彩票网"/></h1></a>
        <a href="/ad/adhead.html" rel="nofollow" class="guideLnk" target="_blank" hidefocus="true"></a>
        <p>
		<span class="serviceTel">
			<span class="serviceTel_tel"><span>客服QQ</span><br/><strong>123456</strong></span>
            <a class="onlineService" href="http://wpa.qq.com/msgrd?v=3&uin=123456&site=qq&menu=yes"
            ...
            <li id="lotteryListEntry">
                ...
                <div id="lotteryList" style="left:0px;display:none;">
                    <div class="lotteryListWrap">
                        <ul>
                            <li class="zyGame"><a href="/lottery/Buy!Ssq.jzh"><em
                                    class="cz_logo35 logo35_ssq"></em><strong>双色球</strong><span class="grayWords"
                                                                                                style="color:#9F5CE1">千万奖金不是梦</span></a>
                            </li>
                            <li class="zyGame"><a href="/lottery/Buy!Dlt.jzh"><em
                                    class="cz_logo35 logo35_dlt"></em><strong>大乐透</strong><span class="grayWords"
                                                                                                style="color:#FE5400">马年马上中大奖</span></a>
                            </li>
                            <li class="zyGame"><a href="/lottery/Buy!Fc3d.jzh"><em
                                    class="cz_logo35 logo35_x3d"></em><strong>福彩3D</strong><span class="grayWords"
                                                                                                 style="color:#D90000">2元赢取1000元</span></a>
                            </li>
                            <li class="zyGame"><a href="/lottery/Buy!Pl3.jzh"><em
                                    class="cz_logo35 logo35_pl3"></em><strong>排列3</strong><span class="grayWords"
                                                                                                style="color:#71B200">天天开奖，奖不停</span></a>
                            </li>
                            <li class="zyGame"><a href="/lottery/Buy!Cqssc.jzh"><em
                                    class="cz_logo35 logo35_ssc"></em><strong>重庆时时彩</strong><span class="grayWords">每天120期哦</span></a>
                            </li>
                            <li class="zyGame"><a href="/lottery/Buy!Sd11x5.jzh"><em
                                    class="cz_logo35 logo35_d11"></em><strong>十一运夺金</strong><span class="grayWords"
                                                                                                  style="color:#0091D1">每天开奖78次</span></a>
                            </li>

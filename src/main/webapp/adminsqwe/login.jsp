<%@ page language="java" import="com.caipiao.utils.UserSession" pageEncoding="utf-8" %>
<%
...
<div class="login">
    <div class="login_table">
        <form action="/admin/AdminUser!Login.jzh" method="post">
            <ul>
                <li>
                    <div class="inputwrap"><span class="tableico"><span class="person"></span></span><input
                            class="textinput" name="username" type="text" placeholder="用户名" maxlength="20"/></div>
                </li>
                <li>
                    <div class="inputwrap"><span class="tableico"><span class="key"></span></span><input
                            class="textinput" name="password" type="password" placeholder="密码" maxlength="20"/></div>
                </li>
                <li>
                    <div class="inputwrap" style="width:137px"><span class="tableico"><span
                            class="card"></span></span><input name="yzm" class="textinput w101" placeholder="验证码"
                                                              type="text" maxlength="5"/></div>
                    <div><img alt="点击刷新" src="/images/image.jsp" width="60"
                              onclick="this.src='/images/image.jsp?'+Math.random();" height="30"
                              style="margin-left:15px;cursor:pointer;"/></div>
                </li>

<%@ page language="java" import="com.caipiao.utils.TimeUtil" pageEncoding="utf-8" %>
    ...
    <TR height=100>
        ...
        <TD>
            <TABLE height=100 cellSpacing=0 cellPadding=0 width="100%" border=0>
                <TR>
                    <TD>当前时间：<%=TimeUtil.getToday(TimeUtil.L_Y)%>
                    </TD>
                </TR>
                <TR>
                    <TD style="FONT-WEIGHT: bold; FONT-SIZE: 16px"><%=request.getSession().getAttribute(UserSession.adminuser)%>
                    </TD>
                </TR>
                <TR>
                    <TD>欢迎进入后台管理中心！</TD>
...
<TABLE cellSpacing=0 cellPadding=2 width="95%" align=center border=0>
    <TR>
        ...
        <TD style="COLOR: #880000">怡情</TD>
    </TR>
    <TR>
        <TD align=right>大赌：</TD>
        <TD style="COLOR: #880000">伤身</TD>
    </TR>
    <TR>
        <TD align=right>常赌：</TD>
        <TD style="COLOR: #880000">灰飞烟灭</TD>
    </TR>
    <TR>
    ...
    <TR>
        ...
        <TD style="COLOR: #880000">网络</TD>
    </TR>
    <TR>
        <TD align=right>Auther：</TD>
        <TD style="COLOR: #880000"><a href="">bcjzh</a></TD>
    </TR>
    <TR>

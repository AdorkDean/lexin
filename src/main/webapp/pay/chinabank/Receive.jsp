...
<TABLE width=500 border=0 align="center" cellPadding=0 cellSpacing=0>
    ...
    <TR>
        <TD vAlign=top align=middle>
            <div align="left"><B><FONT style="FONT-SIZE:14px">MD5鏍￠獙鐮?<%=v_md5str%>
            </FONT></B></div>
        </TD>
    </TR>
    <TR>
        <TD vAlign=top align=middle>
            <div align="left"><B><FONT style="FONT-SIZE: 14px">璁㈠崟鍙?<%=v_oid%>
            </FONT></B></div>
        </TD>
    </TR>
    <TR>
        <TD vAlign=top align=middle>
            <div align="left"><B><FONT style="FONT-SIZE: 14px">鏀粯鍗＄:<%=v_pmode%>
            </FONT></B></div>
        </TD>
    </TR>
    <TR>
        <TD vAlign=top align=middle>
            <div align="left"><B><FONT style="FONT-SIZE: 14px">鏀粯缁撴灉:<%=v_pstring%>
            </FONT></B></div>
        </TD>
    </TR>
    <TR>
        <TD vAlign=top align=middle>
            <div align="left"><B><FONT style="FONT-SIZE: 14px">鏀粯閲戦:<%=v_amount%>
            </FONT></B></div>
        </TD>
    </TR>
    <TR>
        <TD vAlign=top align=middle>
            <div align="left"><B><FONT style="FONT-SIZE: 14px">鏀粯甯佺:<%=v_moneytype%>
            </FONT></B></div>
        </TD>
    </TR>
    </TBODY>
...
<%
        ...
        out.print("鏍￠獙鐮佹湭閫氳繃锛屼笉鏄摱琛屼紶閫掑洖鏉ョ殑鍙傛暟");
    }
%>
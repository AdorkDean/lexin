    ...
    <div class="index_help_con">
        ...
        <div class="new_help_right">
            ...
            <div class="help_t_int">
                ...
                <p>
                    2、大小单双玩法是指猜时时彩“个位”和“十位”这两个位置的“大小、单双”玩法，即把10个自然数按“大”、“小”或“单”、“双”性质分为两组，0-4为小号，5-9为大号，0、2、4、6、8为双号，1、3、5、7、9为单号。投注者可对“个位、十位”的数字进行“大小、单双”的指定投注。投注者投注的号码位置、性质与开奖号码位置、性质相同即中奖。单注投注金额2元，单注中奖金额为4元。</p>
                <p>3、附加玩法.</p>
                ...
                <p>
                    8、如因投注机或通讯故障，投注站销售金额受限等原因造成投注不成功，投注站应立即退还相应收取的投注金额，彩民可选择到其它投注站投注或服务平台投注的方式。如使用卡投注，系统将在一个工作日内返回相应投注款。</p>
                <p>9、每期的每个投注号码的投注注数，根据市场销售情况限量发行。如投注号码受限，投注不能成功，属时时彩游戏规则规定的正常运行情况，投注者只能在该号码恢复销售后继续投注。</p>
                <p>11、未成年人不得参与投注。</p>
                <p><strong>第三章&#12288; 奖金设置</strong></p>
                <p>1、每期销售总额的 50
                    %计提当期返奖奖金。设置奖池，奖池由当期计提奖金与实际中出奖金的差额以及弃奖奖金组成。当期实际中出奖金未达当期计提奖金时，余额进入奖池；当期实际中出奖金超过当期计提奖金时，差额由奖池补充。当奖池总额不足时，由发行经费垫支。</p>
                ...
                <p>第三条</p>
                <p>个位和十位的两个位置"猜大小，猜单双"附加玩法，即把10个自然数按"大""小"，或者"单"，"双" 性质分为两组，0-4为小号，5-9为大号。0，2，4，6，8 为双号。1，3，5，7，9
                    为单号。投注者可对个位和十位的数字性质进行投注，投注者投注的号码位置、性质与开奖号码位置、性质相同即中奖。单注投注金额为2元。</p>
                <p>投注示例如下：</p>
                <p>猜十位和个位为"大小"投注：----大小</p>
                <p>猜十位和个位为"单双投注：-----单双</p>
                <p>第四条</p>
                <p>二星"组选二"附加玩法，即投注者可在0-9这10个自然数中任意选择2个或者2个以上的不同的数字，对十位和个位进行投注，所选号码与当期开奖号码相同且顺序不限，即该注彩票中奖。例如，开奖号码为:34
                    ,彩票为 二星组选34 、43 之一均视为中奖。选择2个不同数字进行组选投注视为1注，单注投注金额为2元。 投注示例如下：</p>
                <p>对十位、个位进行二星"组选二"投注：二星组选二 34</p>
                <p>第五条</p>
                <p>
                    "五星通选"附加玩法，即投注者在00000-99999中选择一个五位数进行投注，所选择的五位数与开奖号码数字全部相同且排列一致，则中的"五星通选"一等奖；如所选择的五位数的首或尾连续三个数与开奖号码首或尾三位数数字相同且排列一致则中得"五星通选"二等奖；依次类推。每个位置上的选择一个号进行投注视为一注。单注投注金额2元。
                    投注示例如下：</p>
                ...
                <p>第三条</p>
                <p>
                    电脑福利彩票时时彩三星幸运附加玩法（以下简称三星幸运），是指将三星投注号码的所有排列方式作为一注投注号码进行的单注投注。如果一注号码的三个数字各不相同，则有6种不同的排列方式，有6个中奖机会，这种投注方式成为"幸运包号"
                    ；如果一注号码的三个数字中有两个数字相同，则有3个不同的排列方式，有3个中奖机会。这种投注方式成为"幸运包对"，单注投注金额人民币2元</p>
                <p>投注示例:</p>
                ...
                <p>中奖示例：</p>
                <p>幸运包号投注为123，当期时时彩开奖号码的后三位为123，132，213，231，321，312
                    均中奖，奖金为160元。幸运包对投注为：113，当期时时彩的开奖号码的后三位为：113，131，311均中奖，奖金为320元。</p>
                <p>第十条</p>

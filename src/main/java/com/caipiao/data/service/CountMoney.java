...
public class CountMoney {
    ...
    private static int getZhushu(String code, String lot) {
        ...
        if ("Cqssc".equals(lot) || "Jxssc".equals(lot) || "Hnssc".equals(lot) || "Ynssc".equals(lot))
            zs = _Ssc(code);
        else if ("Sd11x5".equals(lot) || "Jx11x5".equals(lot) || "Gd11x5".equals(lot) || "Cq11x5".equals(lot) || "Sh11x5".equals(lot))
            zs = _11x5(code);
        else if ("Ssq".equals(lot) || "Dlt".equals(lot) || "Pl5".equals(lot) || "Fc3d".equals(lot) || "Pl3".equals(lot))
            zs = _Def(code);
        else if ("Jsk3".equals(lot) || "Gxk3".equals(lot) || "Ahk3".equals(lot))
            zs = _Kuai3(code);
        else if (LotEmun.Bjpk10.name.equals(lot)) {
            zs = _Bjpk10(code);
        }
        return zs;
    }
        ...
        if (ArrayUtils.contains(PlayType._11x5_ZuXuan, type)) {
            if (CheckUtil.Regex("[0-1][0-9](,[0-1][0-9]){1,10}", co[1])) {
                ...
                if (type.equals(PlayType.T355) || type.equals(PlayType.T352))
                    base = 2;
                else if (type.equals(PlayType.T356) || type.equals(PlayType.T354))
                    base = 3;
                else if (type.equals(PlayType.T357))
                    base = 4;
        ...
        if (ArrayUtils.contains(PlayType._11x5_DanTuo, type)) {
            if (CheckUtil.Regex("[0-1][0-9](,[0-1][0-9]){0,6}[$][0-1][0-9](,[0-1][0-9]){0,10}", co[1])) {
                ...
                if (type.equals(PlayType.T364) || type.equals(PlayType.T362))
                    max = 2;
                else if (type.equals(PlayType.T365) || type.equals(PlayType.T363))
                    max = 3;
                else if (type.equals(PlayType.T366))
                    max = 4;
    ...
    private static int _Kuai3(String code) {
        ...
        if (type.equals(PlayType.T410) || type.equals(PlayType.T409)) {
            ...
            } else if (type.equals(PlayType.T410) && (l0 == 1 || l0 == 2)) {
                int numbase = 3;
                zs = Combination(l1, numbase - l0);
            }
            return zs;
    ...
    private static int _Bjpk10(String code) {
        return TryStatic.StrToInt(code.split(":")[2]);
    }
